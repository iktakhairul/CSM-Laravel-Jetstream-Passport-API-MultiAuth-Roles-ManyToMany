                                ...
                                <tr>
                                    @foreach ($users as $user)
                                        @if($user->role_id === 2)
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">{{ $user->employee_designation }}</div>
        ...
        <div class="mx-auto bg-gray-100" style="margin-bottom: -200px">
            ...
            <x-jet-authentication-card>
                ...
                <form method="POST" action="{{ route('admin.user.index') }}" x-data="{role_id: 2}">
                    ...
                    <div class="mt-4">
                        <x-jet-label for="car_brand" value="{{ __('Car Brand') }}" />
                        <select name="car_brand" x-model="car_brand" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                            <option selected>Select</option>
                            <option>BMW</option>
                            <option>Tesla</option>
                        </select>
                    ...
                    <div class="mt-4">
                        <x-jet-label for="car_model" value="{{ __('Car Model') }}" />
                        <select name="car_model" x-model="car_model" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                            <option selected>Select</option>
                            <option>BMW Model 1</option>
                            <option>BMW Model 2</option>
                            <option>BMW Model 3</option>
                            <option>BMW Model 4</option>
                            <option>BMW Model 5</option>
                            <option>Tesla Model 1</option>
                            <option>Tesla Model 2</option>
                            <option>Tesla Model 3</option>
                            <option>Tesla Model 4</option>
                            <option>Tesla Model 5</option>
                        </select>
                    </div>
